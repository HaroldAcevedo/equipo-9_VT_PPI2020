  ...
  return (
    <div className="fondo">
      ...
      <div className="contenedorEJ">
        ...
        <h2>
          Calienta el aceite en una sartén grande a fuego medio. Agrega las
          cebollas, los pimientos y cocínalos 2 minutos, revolviéndolos de vez
          en cuando.
        </h2>
        ...
        <h2>
          ...
          resto de la crema para cocinar, viértelos en el sartén y cocínalos de
          3 a 4 minutos, o hasta que casi cuajen
        </h2>
        <h2>
          debes de ir levantando los bordes con una espátula e inclinando la
          sartén de vez en cuando para que lo que no se ha cocido se deslice por
          debajo.
        </h2>
        <h2>
